# Shared benchmark problem families and interior-point helpers.
#
# Included by both `runtests.jl` and the standalone comparison scripts in this
# directory so every entry point exercises exactly the same problem definitions.
